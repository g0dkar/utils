...
public class PasswordUtils {
	...
	public static final int BCRYPT_SALT_LENGTH = 11;
	...
	public static String createBCryptHash(final String password) {
		return createBCryptHash(password, BCRYPT_SALT_LENGTH);
	}
	 ...
	 * @return The hash
	 */
	public static String createBCryptHash(final String password, int saltLength) {
		if (BCRYPT_SUPPORT) {
